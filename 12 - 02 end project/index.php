...
<head>
  ...
  <script src='https://themes.getbootstrap.com/wp-content/themes/bootstrap-marketplace/assets/javascript/cookie.js'></script>
  ...
  <script src='https://themes.getbootstrap.com/wp-content/themes/bootstrap-marketplace/assets/javascript/scripts.js?ver=1574664989'></script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"0","time":"1574968644","secure":"1"};
/* ]]> */
</script>
  ...
  <body>
    <style>html{margin-top:0 !important;}</style>
      ...
      <main class="main bg-dark">
        <iframe class="iframe-preview" width="100%" src="https://foxythemes.net/preview/products/maisonnette/"></iframe>
    </main>

    <nav class="navbar navbar-preview fixed-top">
        <div class="container-fluid d-flex justify-content-between align-items-center w-100"><a class="my-lg-0 text-gray-soft" href="https://themes.getbootstrap.com/product/maisonnette-responsive-admin-template/"><i class="bootstrap-themes-icon-left-open-1"></i> View theme <span class="d-none d-sm-inline">info</span></a>
            ...
            <div class="form-inline">
                ...
                <a class="text-gray ml-3" href="https://foxythemes.net/preview/products/maisonnette/">
                  <small>
